 ...
 * @property {Record<string, string>} mappings  - csvHeader → mergeKey (or 'ignore')
 * @property {string[]}               unmapped  - headers not auto-detected
 */
...
export class ColumnMapper {
   ...
   *
   * @param {Record<string, string>} mappings  - existing mappings
   * @param {Record<string, string>} overrides - { csvHeader → newMergeKey }
   ...
   *
   * @param {Record<string, string>} csvRow   - raw CSV row { header: value }
   * @param {Record<string, string>} mappings - { header → mergeKey }
   * @returns {Record<string, string>}        - { mergeKey: value }
   */
